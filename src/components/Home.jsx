...
export default function Home() {
	return (
		<main className="bg-white min-h-screen w-full flex flex-col items-center">
			...
			<header className="sticky top-0 w-full bg-white shadow-md z-50 px-6 py-4 flex justify-between items-center">
			...
			<section
				id="cv"
				className="w-full max-w-[1200px] py-10 px-4 flex flex-col md:flex-row justify-center gap-6 md:gap-16 items-center animate-fade-in">
				<a
			...
			<footer
				id="contact"
				className="w-full max-w-[1200px] py-8 px-4 flex flex-col md:flex-row justify-between items-center text-center animate-fade-in">
