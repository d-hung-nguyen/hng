...
export default function Home() {
	return (
		<main className="bg-white min-h-screen w-full flex flex-col items-center sm:justify-between p-0 md:p-6">
			...
			<section id="about" className="relative w-full flex justify-center h-[170vh] overflow-hidden">
				<div
					className="absolute inset-0 w-full h-full bg-fixed bg-cover sm:top-0 left-50 md:left-1/2 md:-translate-x-1/2"
